  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        type: "text",
        content:
          "量子脅威のタイムライン（業界コンセンサス + Deloitte分析）:\n\n- **今（2025-2026）**: PQC標準が確定、移行計画の策定開始。Deloitte調査で52%の組織がリスク評価中、30%が対策実行中\n- **2027**: 北米大手銀行が「臨界年」と特定（Deloitte/Quantropi対談）\n- **2027-2030**: 早期導入者がPQCへの移行を完了。Apple/Google/IBM/Microsoftは既に実装開始\n- **2030**: NISTがRSA/DH暗号の移行期限として設定\n- **2030-2035**: NIST非推奨化、大規模移行期。金融庁は2030年代半ばまでにPQC利用可能状態を推奨\n- **2030年代後半〜**: CRQC出現の可能性（Deloitte: 5〜10年以内、ML併用で5年未満の可能性も）\n\n移行にかかる期間を考えると、大規模システムでは5-10年の猶予は決して長くありません。DeloitteはPQC移行を「Y2Kの10倍の準備が必要」と表現しています。",
      },
      {
        type: "example",
        content:
