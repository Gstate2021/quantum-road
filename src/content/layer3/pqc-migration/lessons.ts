  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        type: "callout",
        content:
          "リスク評価結果は経営層への報告にも使う。技術的な詳細よりも「何がいつまでに危険か」「対策しない場合の損害額」を明確に伝えることが、予算確保の鍵となる。Deloitteの調査では52%の組織がリスク評価・戦略策定中、30%が対策実行中だが、約18%は何もしていない。「御社はどのグループに属していますか？」という問いかけが効果的。",
        calloutType: "tip",
      },
    ],
    keyConcepts: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        type: "text",
        content:
          "提案後のフォローアップも重要である。初回提案から受注まで3-6ヶ月かかることも珍しくない。その間、量子コンピューティングの最新ニュースを定期的に共有し、顧客の関心を維持する。\n\n提案で使えるDeloitteの権威あるデータ:\n- 「投資した企業の76%が大きな価値を実感」（Deloitte Quantum Computing Futures, 2025）\n- 「PQC移行はY2Kの10倍の準備が必要」（Deloitte Tech Trends 2025）\n- 「2030年に25万人の量子人材が必要だが正規訓練者はわずか12%」\n- 「52%の組織がリスク評価中、30%が対策実行中」（Deloitte Future of Cyber調査）\n- Apple、Google、IBM、Microsoftは既にPQC実装を開始\n- JP Morganは暗号インベントリからPQC移行を開始済み\n\nこれらの数字を提案書に引用することで、「業界の流れに乗り遅れるリスク」を具体的に示せる。",
      },
    ],
    keyConcepts: [
      {
